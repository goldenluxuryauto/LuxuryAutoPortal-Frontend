...
export default function ViewCarPage() {
  ...
  const menuItems: MenuItem[] = [
    ...
    { label: "Total Expenses (Direct Delivery, COGS, Office Support)", path: `/admin/cars/${carId}/expenses` },
    { label: "NADA Depreciation Schedule", path: `/admin/cars/${carId}/depreciation` },
    { label: "$ Purchase Details", path: `/admin/cars/${carId}/purchase` },
    { label: "Totals", path: `/admin/cars/${carId}/totals` },
    { label: "Graphs and Charts Report", path: `/admin/cars/${carId}/graphs` },
    { label: "Payment Calculator", path: `/admin/cars/${carId}/calculator` },
          ...
          <div className="divide-y divide-[#1a1a1a]">
            {menuItems.map((item, index) => (
              ...
              >
                ...
                <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-[#EAEB80] transition-colors" />
              </button>
            ))}
          </div>
        </div>
