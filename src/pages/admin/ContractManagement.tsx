...
import { Upload, Eye, Star, Trash2, Loader2, FileText, X } from "lucide-react";
  ...
  const setDefaultMutation = useMutation({
    mutationFn: async (id: number) => {
      const response = await fetch(
        buildApiUrl(`/api/contracts/${id}/set-default`),
        {
          method: "PATCH",
          credentials: "include",
        }
                        ...
                        {contract.id !== 0 && (
                          <>
                            <Button
                              ...
                              onClick={() =>
                                setDefaultMutation.mutate(contract.id)
                              }
                              disabled={
                                contract.isDefault ||
      ...
      <Card className="bg-[#111111] border-[#EAEB80]/20">
        <CardHeader>
          ...
          <p className="text-sm text-gray-400 mt-1">
            Contracts signed by clients and stored in
            public_html/signed-contracts/
          </p>
        </CardHeader>
        <CardContent>
          {isLoadingSigned ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm mt-2">
                Signed contracts will appear here automatically
              </p>
            </div>
          ) : (
            <Table>
                  ...
                  error={
                    <div className="p-8 text-center space-y-4 min-h-[600px] flex flex-col items-center justify-center">
                      ...
                      <p className="text-sm text-gray-500">
                        The PDF file may be accessible directly. Try opening it
                        in a new tab.
                      </p>
                      <Button
                        variant="outline"
